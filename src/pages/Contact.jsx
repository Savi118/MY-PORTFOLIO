    ...
    <section className='w-full py-20 px-4 sm:px-6 bg-green-50/40'>
      <div className='max-w-6xl mx-auto'>
        ...
        <p className='text-center mt-3 text-green-800 max-w-xl mx-auto text-sm sm:text-base'>
          Whether you're hiring, looking for a collaborator, or want to start a
          new full-stack project — I’d love to connect.
        </p>
        ...
        <div className='mt-16 grid grid-cols-1 md:grid-cols-2 gap-10'>
          ...
          >
            ...
            <p className='text-green-800 leading-relaxed text-sm sm:text-base'>
              With experience in{" "}
              <strong>MERN stack, REST APIs, Auth, UI/UX,</strong> and deploying
              complete apps, I’m excited to work on projects that make a real
              impact.
            </p>
